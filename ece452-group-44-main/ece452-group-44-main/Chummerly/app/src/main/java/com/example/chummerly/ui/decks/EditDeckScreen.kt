...
fun EditDeckScreen(
    ...
    Column(
        ...
        Text(text = "Edit Deck", modifier = Modifier.align(Alignment.Start).padding(vertical = 16.dp), fontSize = 24.sp, fontWeight = FontWeight.Bold)
        ...
        OutlinedTextField(
            ...
            onValueChange = {
                editDeckViewModel.updateName(it)
            },
        ...
        ExposedDropdownMenuBox(expanded = isExpanded, onExpandedChange = { isExpanded = it }) {
            TextField(
                ...
                onValueChange = {
                    if (it != "") {
                        editDeckViewModel.updateCategory(it)
                    }
                },
                readOnly = true,
            ...
            ExposedDropdownMenu(
                ...
                uiState.categories.forEach() {category ->
                    DropdownMenuItem(
                        ...
                        onClick = {
                            editDeckViewModel.updateCategory(category.name)
                            isExpanded = false
                        }
                    )
                }
        ...
        OutlinedTextField(
            ...
            onValueChange = {
                editDeckViewModel.updateDescription(it)
            },
