...
@Composable
fun ShuffledStudyScreen(
    shuffledStudyViewModel: ShuffledStudyViewModel = hiltViewModel(),
    onClose: () -> Unit,
    onFinishShuffledStudy: () -> Unit,
    readText: (String) -> Unit
) {
    val uiState by shuffledStudyViewModel.uiState.collectAsState();
    //System.out.println("hey"+ uiState.cards)
